    ...
    <div id="layout">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-left">
                            <li><a href="#"><i class="fa fa-phone"></i> +12345678</a></li>
                            <li><a href="#"><i class="fa fa-envelope"></i>
                                    homeservice@homeservice.al</a></li>
                        </ul>
                        <ul class="visible-xs visible-sm">
                            <li class="text-left"><a href="#"><i class="fa fa-phone"></i>
                                    +12345678</a></li>
                            <li class="text-right"><a href="#"><i class="fa fa-map-marker"></i>Durres, Albania</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-right">
                            ...
                            <li><a href="#"><i class="fa fa-map-marker"></i>Durres, Albania</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <header id="header" class="header-v3">
            <nav class="flat-mega-menu">
                ...
                <ul class="collapse">
                    <li class="title">
                        <a href="/"><img src="{{ asset('images/categories/1521969419.png') }}" width="10px"
                                height="90px"></a>
                    </li>
                    <li> <a href="{{ url('service_categories') }}">Service Categories</a>
                    ...
                    @if (Route::has('login'))
                        @auth
                            ...
                            @elseif (Auth::user()->usertype === 'svp')
                                <li class="login-form"> <a href="{{ route('svp.profile') }}" title="Register">My Account
                                        (Service
                                        Provider)</a>
                                    <ul class="drop-down one-column hover-fade">
                                        <li><a href="{{ route('svp.dashboard') }}">Dashboard</a></li>
                                        <li><a href="{{ route('svp.profile') }}">Profile</a></li>
                                        <li><a href="{{ route('logout') }}"
                                                onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
                                        </li>
                ...
                <div class="row visible-md visible-lg">
                    ...
                    <div class="col-md-3 col-xs-6 col-sm-6">
                        ...
                        <ul class="contact_footer">
                            <li class="location">
                                <i class="fa fa-map-marker"></i> <a href="#">Durres,Albania</a>
                            </li>
                            <li>
                                <i class="fa fa-envelope"></i> <a
                                    href="mailto:contact@surfsidemedia.in">homeservice@homeservice.com</a>
                            </li>
                            <li>
                                <i class="fa fa-headphones"></i> <a href="#">+12345678</a>
                            </li>
                        </ul>
                ...
                <div class="row visible-sm visible-xs">
                    <div class="col-md-6">
                        ...
                        <ul class="contact_footer mlist">
                            ...
                            <li>
                                <i class="fa fa-envelope"></i> <a href="#">homeservice@homeservice.com</a>
                            </li>
                            <li>
                                <i class="fa fa-phone"></i> <a href="#">+12345678</a>
                            </li>
                        </ul>
            ...
            <div class="footer-down">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p class="text-xs-center crtext">&copy; 2023 All Rights Reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
